...
def get_summary(filename="1.mp4", subtitles="1.srt", duration=60):
    """ Abstract function
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--durations', help="summarized video durations", type=int, default=60)
    ...
    if not url:
        ...
        get_summary(args.video_file, args.subtitles_file, args.durations)
